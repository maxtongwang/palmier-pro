...
final class ToolExecutor {
    ...
    private func run(_ tool: ToolName, _ editor: EditorViewModel, _ args: [String: Any]) async throws -> ToolResult {
        ...
        case .createMulticam: return try await createMulticam(editor, args)
        case .switchAngle:   return try switchAngle(editor, args)
        case .deleteMulticam: return try deleteMulticam(editor, args)
        case .rollEdit:      return try rollEdit(editor, args)
