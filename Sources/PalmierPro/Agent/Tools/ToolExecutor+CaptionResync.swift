...
extension ToolExecutor {
    ...
    func resyncCaptions(_ editor: EditorViewModel, _ args: [String: Any]) throws -> ToolResult {
        ...
        let maxWords = args.int("maxWords")
        ...
        // args.int handles MCP numeric shapes (Double-encoded ints); a raw cast would silently
        // drop the window and fall through to every caption group.
        ...
        if let groupId {
            ...
            // One-sided windows are valid: the missing side spans to the timeline edge.
            let s = rangeStart ?? 0
